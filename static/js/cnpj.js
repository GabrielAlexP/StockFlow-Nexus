const cnpjInput = document.getElementById('cnpj');
      ...
      document.getElementById("search-form").addEventListener("submit", function (event) {
        ...
        // Exibe os botões de ação e o select novamente
        document.getElementById('inserir-em').style.display = 'block';
        document.getElementById('action-buttons').style.display = 'flex';

        // Exibe o container de dados
        const dataContainer = document.getElementById("data-container");
        dataContainer.style.display = 'flex';
      ...
      document.getElementById("atualizar").addEventListener("click", function () {
        if (confirm("Você tem certeza que quer atualizar estes dados no sistema?")) {
          ...
          const inserirEmSelect = document.getElementById("inserir-em");
          const inserirEm = inserirEmSelect.value; // Deve ser "cliente", "fornecedor" ou "ambos"
          if (!inserirEm) {
