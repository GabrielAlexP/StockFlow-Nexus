...
def descriptografar_email():
    chave1 = carregar_chave('config/chave_email1.key')
    chave2 = carregar_chave('config/chave_email2.key')

    with open('config/email.json.enc', 'rb') as file:
        iv1 = file.read(16)
        iv2 = file.read(16)
